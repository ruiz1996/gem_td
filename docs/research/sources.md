...
- 同日全局差异核查：逐条比对38条常规配方和13条隐藏配方；追踪本轮隐藏资格、护国动态攻击/燃尽、祖母绿复制、镇家特殊融合、石板与海豹联动，识别仅装饰的e系列技能；用当前引擎隔离复现合成资格、减益错误续期、折翼/碧玺权限与叉状闪电漏主目标。报告见[全局差异清单](../../game/docs/current-original-differences.md)，未修改玩法。补充[Valve 7.07](https://www.dota2.com/duelingfates?l=schinese)和[7.20](https://www.dota2.com/720?l=schinese)官方护甲公式变更，作为历史客户端版本核验依据。
